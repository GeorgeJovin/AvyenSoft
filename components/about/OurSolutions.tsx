...
const Solutions = () => {
  const data = [
    {
      ...
      description:
        "Innovative frameworks that adapt to diverse industries and market demands.",
    },
    {
      title: "Process Automation Tools",
      description:
        "Cutting-edge technology to simplify operations and enhance productivity.",
    },
    {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          'url("https://ayvensoft.com/wp-content/uploads/2024/12/h2-bg3.jpg")',
          ...
          {data.map((item, index) => (
            ...
            >
              <div className="flex flex-col">
                <h3 className="text-[14px] font-bold mb-2 text-white">
                  {item.title}:
                </h3>
